...
<!--								<span>1 Comment</span>-->
							...
							<div class="row py-2">
								<div class="col-lg-4 col-md-4 col-12">
									<img src="./admin/upload/<?php echo $row['post_img']; ?>" alt="post pic" class="img-fluid">
								</div>
								<div class="col-lg-8 col-md-8 col-12">
									<p><?php echo substr($row['description'],0,130) . "..."; ?></p>
									<a href="single.php?id=<?php echo $row['post_id']; ?>"><button class="btn btn-danger">Read More</button></a>
								</div>
							</div>
